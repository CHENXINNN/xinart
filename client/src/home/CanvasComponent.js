    ...
    return (
      ...
      <canvas  className = "rightEye"  ref={this.myRef_rightEye} width={80} height={80}/>
          ...
          <Link  
            ...
            <div className = "tag tag1" >技术博客</div>
          </Link>
          <img className = 'food1'  style = {this.state.mouseOver1 ? {opacity: 0} : {opacity: 1}} src = '/imgs/food.jpg' alt = ''/>
          ...
          <Link 
            ...
            to = '/life/music'>
            <div className = "tag tag2" >生活记录</div>
            <img className = 'bowl2' src = '/imgs/bowl.jpg' alt = ''/>
          </Link>
          <img className = 'food2' style = {this.state.mouseOver2 ? {opacity: 0} : {opacity: 1}} src = '/imgs/food.jpg' alt = ''/>
          ...
          <div className = "tag tag3" >关于我</div>
          </Link>
          <img className = 'food3'  style = {this.state.mouseOver3 ? {opacity: 0} : {opacity: 1}} src = '/imgs/food.jpg' alt = ''/>
